...
/**
 * 
 * Contains a program to create a Scandal questionnaire.
 * @see Building Java Programs (Chapter 4)
 * @author Alyssa Morales <amorales@skidmore.edu>
 *
 **/

public class ScandalQuestionaire {
	...
	public static void main(String[] args) {
		...
		//Here I am allowing the user to input A., B.,C., or D.
